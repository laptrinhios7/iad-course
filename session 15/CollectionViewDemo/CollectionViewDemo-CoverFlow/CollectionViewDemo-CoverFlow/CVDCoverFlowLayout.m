...
@implementation CVDCoverFlowLayout
...
{
    return [CVDCollectionViewLayoutAttributes class];
}
...
-(void)applyLayoutAttributes:(UICollectionViewLayoutAttributes *)attributes forVisibleRect:(CGRect)visibleRect
{
    ...
    [(CVDCollectionViewLayoutAttributes *)attributes setShouldRasterize:YES];
    [(CVDCollectionViewLayoutAttributes *)attributes setMaskingValue:maskAlpha];
}
