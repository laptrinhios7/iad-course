...
@interface CVDBookShelfLayout()
{
    NSDictionary *_shelfFrames;
}
@end

@implementation CVDBookShelfLayout
...
- (id)init
{
    ...
    [self registerClass:[CVDBookShelfDecorationView class] forDecorationViewOfKind:[CVDBookShelfDecorationView kind]];
...
- (NSArray *)layoutAttributesForElementsInRect:(CGRect)rect
{
    ...
    [_shelfFrames enumerateKeysAndObjectsUsingBlock:^(id key, id shelfRect, BOOL *stop)
    {
        if (CGRectIntersectsRect([shelfRect CGRectValue], rect))
        {
            ...
            [self layoutAttributesForDecorationViewOfKind:[CVDBookShelfDecorationView kind] atIndexPath:key];
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForDecorationViewOfKind:(NSString *)decorationViewKind atIndexPath:(NSIndexPath *)indexPath
{
    ...
    [UICollectionViewLayoutAttributes layoutAttributesForDecorationViewOfKind:decorationViewKind withIndexPath:indexPath];
